...
as
begin
if sys_context( 'userenv', 'session_user' ) not in ('WEALTHDBA', 'SYS', 'SYSTEM', 'SRVWEALTHDBA', 'PRDNLINK','PRDSLINK','PRDWORKFLOW','PRDFORTE','PRDOLT','PRDRLINK','PRDFEED,PRDEVENTS','PRDDATAMOD,PRDSM5','PRD_NLINK_APP','FACTUSER','RI_STAGING','RFSUSER')
then
    return  '1=0';
else 
  return '1=1';
